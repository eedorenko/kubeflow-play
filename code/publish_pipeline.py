...
def main():
    ...
    try: 
        ...
        # pipeline_params = {}
        # pipeline_params["tenant_id"] = "72f988bf-86f1-41af-91ab-2d7cd011db47"
        # pipeline_params["service_principal_id"] = "6e85e789-3b22-4edb-89d0-2ab7fc09d488"
        # pipeline_params["service_principal_password"] = "73c9a58f-6080-4ff1-9619-e0e3c0a35d7f"
        # pipeline_params["subscription_id"] = "0fe1cc35-0cfa-4152-97d7-5dfb45a8d4ba"
        # pipeline_params["resource_group"] = "kubeflowyo"
        # pipeline_params["workspace"] = "kubeflowyo-aml-ws"
        # exp = client.get_experiment(experiment_name=experiment_name)
        # client.run_pipeline(exp.id, job_name=pipeline_name, pipeline_package_path=pipeline_file, params=pipeline_params, pipeline_id="81ccc728-d6a0-4260-b6f7-21f20779c640")
        
    except TypeError as err:
        print("An error related to this issue https://github.com/kubeflow/pipelines/issues/3441 {0}".format(err))
